...
date: 2026-03-15
summary: "Early architecture research — one of the initial specs I worked through before building Catalyst Radar. A systems case study on multi-timeframe execution: reconciling conflicting signals across timeframes into a single net position."
category: project
status: archived
draft: true
